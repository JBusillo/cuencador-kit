...
const icons = ["MenuIcon", "GlobeIcon", "LogInIcon", "LogOutIcon", "SettingsIcon", "MoonIcon", "HelpCircleIcon", "MailIcon", "InfoIcon"]
...
`
for (let x of icons) {
  let f = x.replace(/([a-z]+)([A-Z])/g, (p1, p2, p3) => {
    return p2 + '-' + p3
...
fs.ensureDir(path.dirname(filepath))
  .then(() => fs.writeFile(filepath, source, 'utf8'))
