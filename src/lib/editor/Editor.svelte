...
<div class="overflow-y-scroll">
	<button id="ed_bmarkdown" on:click={Show} class="border-2 bg-blue-100"> Markdown </button>
	<button id="ed_bhtml" on:click={Show} class="border-2"> HTML </button>
	<button id="ed_bpreview" on:click={Show} class="border-2 bg-blue-100"> Preview </button>
